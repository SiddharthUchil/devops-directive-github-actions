# Capstone – GitHub Actions Project

This repository contains the capstone project for the [DevOps Directive GitHub Actions](https://github.com/SiddharthUchil/devops-directive-github-actions). Top-level directories include .github/ (workflows, composite actions, and config), services/ (the microservices), deploy/kubernetes/, utils/, plus a root Taskfile.yaml used by many workflows. ￼
...
2. **Build and Push Container Images** – .github/workflows/build-push.yaml
   ...
   • tagged releases matching \*_@[0-9]_.[0-9]_.[0-9]_, and
